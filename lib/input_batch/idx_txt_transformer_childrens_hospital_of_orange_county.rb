...
class InputBatch::IdxTxtTransformerChildrensHospitalOfOrangeCounty< InputBatch::IndexCsvTransformer

  def process_csv cvs
    InputBatch.log.info "Opened csv file for processing  cchhooccc"
